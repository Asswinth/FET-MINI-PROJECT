class GovernmentForm {
    ...
    submitForm(): void {
        ...
        const phone: string = $('#phone').val() as string;
        const address: string = $('#address').val() as string;
        const nationality: string = $('#nationality').val() as string;
        const citizenship: string = $('#citizenship').val() as string;
        const gender: string = $('#gender').val() as string;
        const comment: string = $('#comment').val() as string;
        const dob: string = $('#dob').val() as string;
